...
class SliderLinePage extends StatefulWidget {
  ...
  SliderLinePage(this.seriesList, {this.animate});

  /// Creates a [LineChart] with sample data and no transition.
  factory SliderLinePage.withSampleData() {
    return new SliderLinePage(
      _createSampleData(),
...
class _SliderCallbackState extends State<SliderLinePage> {
